...
public class BusinessCardController {
  private final List<BusinessCard> businessCardList = List.of(
      ...
      new BusinessCard("Barbora Bühnová", "Czechitas z. s.", "Šumavská 15", "602 00 Brno-Královo Pole", "bara@czechitas.cz", "123", "www.czechitas.cz"),
      ...
      new BusinessCard("Mirka Zatloukalová", "Czechitas z. s.", "Václavské náměstí 837/11", "11000 Praha 1", "mirka@czechitas.cz", "+420 800 123 456", "www.czechitas.cz")
  );
